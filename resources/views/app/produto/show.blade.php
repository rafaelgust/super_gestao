    ...
    <div class="container my-4">
        <div class="row mb-4">
            <div class="col text-center">
                <h2 class="fw-bold">Detalhes do Produto</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="shadow p-4 rounded bg-white">
                    ...
                    <div class="mt-4">
                        <h5 class="fw-bold">Detalhes do Produto:</h5>
                        <ul class="list-unstyled">
                            <li>
                                <span class="fw-semibold">Peso:</span> {{ optional($produto->detalhes)->peso ?? '---' }} kg
                            </li>
                            <li>
                                <span class="fw-semibold">Dimensões:</span> 
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('produto.edit', $produto->id) }}" class="btn btn-primary fw-bold">Editar</a>
                        <form action="{{ route('produto.destroy', $produto->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja apagar este produto?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger fw-bold">Apagar</button>
                        </form>
                    </div>
                </div>
            </div>
