...
@section('conteudo')
    ...
    <div class="container my-3">
        <h2 class="text-center mb-4">Criar Pedido de Venda</h2>
            ...
            <form action="" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col text-start">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary" id="btn-adicionar-produto" onclick="pedidoVenda.adicionarProduto(event)">Adicionar Produto</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="row mt-5">
            ...
            <div class="mb-3 text-end col">
                <button class="btn btn-primary" id="btn-finalizar-venda" onclick="pedidoVenda.finalizarPedido(event)">Finalizar Venda</button>
            </div>
        </div>
    </div>
@endsection
...
class PedidoVenda {
    constructor(notaFiscal, clienteId, produtos) {
    ...
    finalizarPedido(e) {
        ...
        if (!notaFiscal || !clienteId || !data_do_pedido || !data_entrega) {
            Swal.fire({
...
const pedidoVenda = new PedidoVenda(
    '',
    @json(old('cliente_id', isset($clienteId) ? $clienteId : null)),
    []
);
...
class Produto {
    ...
    renderizarItem() {
        ...
        btnDiminuir.addEventListener('click', () => {
            pedidoVenda.diminuirQuantidadeProduto(this.id);
        });
        btnAumentar.addEventListener('click', () => {
            pedidoVenda.aumentarQuantidadeProduto(this.id);
        });
        btnRemover.addEventListener('click', () => {
            pedidoVenda.removerProduto(this.id);
        });
